...
categories:
  - Hexo魔改
swiper_index: 7
swiper_description: 怀念同胞、庆祝节日的弹窗和滤镜功能
cover: https://bu.dusays.com/2022/09/01/63103a7114c00.webp
updated: 2024-07-14 14:50:19
---
前置教程：
...
因群友所述部分文字不合理，已经进行了一些修改

![1661593693449](https://bu.dusays.com/2023/01/20/63ca120459694.webp)

效果如下：

![灰色滤镜](https://bu.dusays.com/2023/01/20/63ca120b1e153.webp)

![弹窗提示](https://bu.dusays.com/2024/07/14/66936c44a598f.png)

![庆祝提示](https://bu.dusays.com/2023/01/20/63ca121ac5edf.webp)
...
以下内容仅针对 `hexo-themes-butterfly`，其它主题请自行调整

{% hideToggle 点击查看教程 %}

新建 `blogRoot/themes/butterfly/source/js/day.js` **（不要放在 `blogRoot/source` 里面）**，然后编写以下内容
...
由于有农历计算，不想使用api导致网站速度变慢，所以使用本地数据库索引，农历计算js使用CSDN上面的：
...
把这个文件放在 `[blogRoot]/themes/butterfly/source/js/lunar.js`

然后引入弹窗js、农历js和SweetAlert库

在主题配置文件的 `inject`里面引入该js
...
inject:
  ...
  - <script type="text/javascript" src="https://npm.elemecdn.com/sweetalert2@8.19.0/dist/sweetalert2.all.js"></script>
```

当然链接你也可以换成 `https://unpkg.com/sweetalert2@8.19.0/dist/sweetalert2.all.js`之类的

如果你嫌js太大的话也可以使用目前我的cdn，但是不确保以后可用:

`/js/lunar.js`

`/js/day.js`

然后 `hexo cl&&hexo g -d`一气呵成即可，欢迎反馈问题。
